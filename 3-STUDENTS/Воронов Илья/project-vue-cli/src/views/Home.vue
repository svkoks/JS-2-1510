  ...
  <div class="home">
    <div class="wrapper">
      <header>
        <div class="header-wrap">
          <div class="head content">
            <div class="head-left">
              ...
              <form action="#" class="search" name="search" method="GET">
                ...
                <label for="browse"
                  ><a>browse <i class="fas fa-caret-down"></i></a
                ></label>
          ...
          <nav class="menu-nav">
            <ul class="menu">
              <li><a href="#" class="menu__link-1 active">Home</a></li>
              <li>
              ...
              <li>
                <a href="checkout.html" class="menu__link-7">Hot deals</a>
              </li>
            </ul>
          </nav>
        </div>
    ...
    <div class="banners-wrap">
      <div class="banners content">
        <div class="banners__item">
          ...
          <img
            src="https://raw.githubusercontent.com/IlyaVoronOFF/pictureStatic/master/Brand/banners/men.jpg"
            alt="hot deal"
          />
        </div>
        <div class="banners__item">
          <div class="banners__text">
            <h2>luxerious & trendy</h2>
            <h1>Accoseries</h1>
          </div>
          <img
            src="https://raw.githubusercontent.com/IlyaVoronOFF/pictureStatic/master/Brand/banners/accesories.jpg"
            alt="trendy"
          />
        </div>
        <div class="banners__item">
          ...
          <img
            src="https://raw.githubusercontent.com/IlyaVoronOFF/pictureStatic/master/Brand/banners/women.jpg"
            alt="offer"
          />
        </div>
        <div class="banners__item">
          ...
          <img
            src="https://raw.githubusercontent.com/IlyaVoronOFF/pictureStatic/master/Brand/banners/kids.jpg"
            alt="kids"
          />
        </div>
      </div>
    ...
    <div class="discount-wrap">
      <div class="discount content">
        <div class="discount__banner">
          <img
            src="https://raw.githubusercontent.com/IlyaVoronOFF/pictureStatic/master/Brand/discount/01.jpg"
            alt="offer"
          />
        ...
        <div class="item-group">
          <div class="discount__item">
            <img src="@/assets/img/discount/Forma-1.png" alt="delivery" />
          ...
          <div class="discount__item">
            <img src="@/assets/img/discount/Forma-2.png" alt="sales" />
            <div class="item__text">
          ...
          <div class="discount__item">
            <img src="@/assets/img/discount/Forma-3.png" alt="quality" />
            <div class="item__text">
    ...
    <div class="subscribe-wrap">
      <div class="subscribe content">
        <div class="feedback">
          <img src="@/assets/img/subscribe/photo.png" alt="photo" />
