      ...
      <div class="row">
        <div class="col-12 col-md-6 offset-md-1">
          <form class="formValidation" action="" method="" style="width:100%;">
            ...
            <input type="tel" class="tel field mb-3" name="tel" placeholder="tel"><br>
            <input type="email" class="email field mb-3" name="email" placeholder="email"><br>
            <textarea class="textarea field mb-3" id="" rows="5" name="text" placeholder="text here..."></textarea><br>
